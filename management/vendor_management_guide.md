...
This is where vendor management meets the regulator — and where this guide's banking context (Cymbal Bank, Singapore) bites. The full regulatory landscape (MAS, DORA, BCP, sanctions/AML) is covered in [../banking/financial_risk_compliance_systems_guide.md](../banking/financial_risk_compliance_systems_guide.md); the vendor-management-relevant core, verified as of August 2026:
