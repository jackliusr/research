...
8. [The Worked Example](#8-the-worked-example) — the Cymbal Bank platform case, the TCO–NPV worked case, the lessons
...
- **Corporate:** the cost of capital — usually **WACC** (the blended cost of equity and after-tax debt — cross-ref [mba_body_of_knowledge_guide.md](mba_body_of_knowledge_guide.md) §6.3) — or the divisional hurdle rate. A Cymbal Bank investment committee will have a published hurdle; use it, and name it.
