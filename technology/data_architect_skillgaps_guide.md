...
- **Cloud data migration**: lift-and-shift vs. re-platform vs. re-architect decision frameworks, dual-run and cutover strategies, migration of on-prem Teradata/Oracle/Exadata estates (a real Cymbal Bank problem), data validation and reconciliation during migration.
...
Ranking logic: (a) frequency and difficulty of the topic in real data-architect assessments and in Cymbal Bank enterprise data work, (b) whether the gap is a standing priority, (c) leverage — one guide covering many interview/assessment situations. **Standing priorities (Zero Trust, Platform Engineering, business case/TCO) are items #2, #3, #4** — each verified as a real gap by this scan.
...
| Gap | Interview frequency (2026 assessments) | Cymbal Bank work relevance | Effort to close | Net priority |
|---|---|---|---|---|
...
| Ongoing | Apply: volunteer for Cymbal Bank data-platform/data-governance initiatives to convert knowledge into evidence | Work artifacts that mirror the guides |
