...
*Guide written for the research repository of Jack Liu Shurui, Solution Architect at Crédit Agricole CIB. Part of the LLM/AI optimization series alongside LLM optimization, model pruning, compression alternatives, and fine-tuning frameworks guides.*
