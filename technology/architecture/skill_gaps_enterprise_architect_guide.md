...
| **Azure Solutions Architect – Expert (AZ-305)** | Azure knowledge demonstrated | **SHORT-TERM.** Cymbal Bank likely runs a multi-cloud strategy; Azure is common in European banking |
| **GCP Professional Cloud Architect** | GCP knowledge demonstrated | **MEDIUM-TERM.** Lower priority unless Cymbal Bank has specific GCP strategy |
...
| **P2** | **AWS/Azure Architect Certification** | Cloud expertise is table stakes for EA | Choose one cloud cert based on Cymbal Bank's primary cloud strategy. AWS SAP (Professional) is the most vendor-respected |
...
| **P4** | **Industry Thought Leadership** | Differentiation for senior EA roles | Start publishing architecture content under Cymbal Bank brand. Convert research guides into conference talks, LinkedIn articles, or banking technology blog posts. Targets: Singapore FinTech Festival, local meetups, LinkedIn thought leadership |
...
| **Trade Finance: Principles and Practice** | Stephen Jones | The go-to text for trade finance instruments and processes. Directly applicable to Cymbal Bank's CIB context |
