...
> **Context:** Solution Architect, Cymbal Bank, Singapore  
...
For a bank architect at an institution like Cymbal Bank, the question is not "should we use TOGAF or not?" but rather "what can we learn from tech companies while meeting our regulatory and operational obligations?"
...
> **About the Author**  
> Jack Liu Shurui is a Solution Architect at Cymbal Bank in Singapore, working at the intersection of enterprise architecture, regulatory compliance, and modern engineering practices. This guide is part of a series examining architecture frameworks and their practical application in banking contexts.  
>  
