...
<process name="FileArrivalNotify">
  <startEvent trigger="file" mailbox="/Cymbal Bank/INCOMING/SWIFT"/>
...
```jcl
//NOTIFY JOB (Cymbal Bank),'FILE ARRIVAL',CLASS=A
//EXEC PGM=IKJEFT01
//SYSTSIN DD *
...
*Updated July 2026 — Jack Liu Shurui, Cymbal Bank Singapore*
