...
For a bank — and for the author's context at Cymbal Bank — methodology selection is dominated by one fact: **the delivery process itself is audited.** Regulators and internal audit examine not just *what* was delivered but *how it was controlled*: change management, testing evidence, approval records, risk decisions. This is the "audit trail requirement" that shapes everything.
