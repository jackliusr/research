...
You are a **Solution Architect at Cymbal Bank, Singapore** (the author's own seat — the familiar context). The local branch is reviewing two software decisions at once:
...
Both decisions share a question: *how do you evaluate a Singapore-born SaaS vendor against the standards a Cymbal Bank entity must meet?* The evaluation framework below is the design.
