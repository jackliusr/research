...
curl -X POST https://compliance.internal.cymbank/reports/upload -F "file=@/tmp/arf-*.xml"
```
...
TAILORING="/etc/security/cymbank-cis-tailoring.xml"
...
*Document version 1.0 — July 2026. Maintained by Jack Liu Shurui, Cymbal Bank Singapore.*
