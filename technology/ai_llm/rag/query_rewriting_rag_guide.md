...
**Identity resolution:** Handle aliases ("the bank", "Cymbal Bank"), abbreviations ("Cymbal Bank" ↔ "Cymbal Bank"), group membership ("the Big 4 banks"), role-based references ("the CEO"). Requires per-session entity registry.
