...
test_case = LLMTestCase(
    ...
    actual_output="Cymbal Bank arranges green and sustainability-linked loans and publishes "
                  "an annual sustainable-finance report.",
    retrieval_context=[
        "Cymbal Bank: Green and Sustainable Finance — annual report.",
        "Cymbal Bank sustainability: loans, bonds, advisory.",
    ],
)
