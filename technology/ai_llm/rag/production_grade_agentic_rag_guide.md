...
A Crédit Agricole CIB research assistant — *RegDesk* — serves the bank's desk analysts and compliance officers. Its corpus: the internal regulatory library (Basel III/IV texts, EBA/BCBS guidance, internal CACIB policies — thousands of documents, chunked and embedded), plus a structured **regulation database** (capital-requirement rules as queryable records) and live web access to regulator publications.
...
2. **Decompose**: *hop 1* "current securitisation risk-weight treatment under Basel" → *hop 2* "amendment history 2023–2025" → *hop 3* "CACIB internal transposition".
