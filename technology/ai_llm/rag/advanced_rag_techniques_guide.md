...
For a Cymbal Bank context (regulatory Q&A, KYC/AML, counterparty risk research, sanctions screening, internal policy lookup), the layered architecture of §10.3 maps onto concrete workloads:
