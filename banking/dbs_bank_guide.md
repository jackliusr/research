...
2. **The core doesn't need replacing to be modern.** Wrapping the core with APIs and modernising incrementally delivered a decade of innovation without a big-bang core programme. For architects at incumbent banks (including Cymbal Bank contexts), this is the validated path: strangler-fig, API-first, data out.
